  ...
  return (
    <div className="common-error">
      <div className="error-container">
        <Heading><Text strong>0110 1010 0100...Err!</Text></Heading>
        <Paragraph className="error-desc">
          <Text type="secondary">
            Unexpected error occured, refresh the page and contact administrator if the issue persist.
          </Text>
        </Paragraph>
...

        {
          isShown && (
            <div className="error-details">
              ...
              <Text
                type="secondary"
                link={`https://github.com/maeek/neutrino-chat/issues?q=${encodeURIComponent(message + '')}`}
