...
import { Input } from '@maeek/neutrino-design/components/inputs/text/Input';
...
export const MainSearchBar = () => {
  ...
  const firstSuggestionsRef = useRef<HTMLLIElement>(
    null as unknown as HTMLLIElement
  );
  const lastSuggestionsRef = useRef<HTMLLIElement>(
    null as unknown as HTMLLIElement
  );
