...
import { Checkbox } from '@maeek/neutrino-design/components/inputs/checkbox';
import { CheckboxProps } from '@maeek/neutrino-design/components/inputs/checkbox/Checkbox';
...
export interface CheckboxBoxProps extends Omit<CheckboxProps, 'onChange'> {
  title: string;
  field: string;
  name?: string;
  description?: string;
      ...
      <div className='checkbox-box-container' onClick={onClickHandler}>
        <div
          className={classNames(
            'checkbox-box-title',
            disabled && 'checkbox-box-title--disabled'
          )}
        >
